...
text(ax, u(1) + 0.026, u(2) + 0.058, 'cell to complete', ...
...
draw_arrow(ax, [0.850 0.825], u + [0.022 0.008], colors, '--', '', [], colors.feedback, 1.4);
text(ax, 0.600, 0.835, 'procedure choice', ...
    'FontSize', 9.0, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
text(ax, 0.845, 0.850, {'later release', 'validation'}, ...
    'FontSize', 9.0, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
end
...
text(ax, sep_x + 0.20, box(2) + box(4) + 0.035, 'validation population', ...
    'FontSize', 9.0, 'HorizontalAlignment', 'center', 'Interpreter', 'none');
text(ax, sep_x + 0.22, box(2) + 0.070, 'comparable / held-out cells', ...
    'FontSize', 8.4, 'HorizontalAlignment', 'center', ...
...
text(ax, 0.50, arrow_y + 0.070, 'completion rule', ...
    'FontSize', 8.6, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
