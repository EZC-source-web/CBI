...
WC(27:T, 1:4) = 0;
WC(:, split + 1:end) = 1;
validation_gap = rand(T, N - split) < 0.10;
WC(:, split + 1:end) = double(~validation_gap);
VC = false(T, N);
...
for m = 1:numel(tt)
    rectangle(ax, 'Position', [box(1) + (jj(m) - 1) * cw, box(2) + (tt(m) - 1) * ch, cw, ch], ...
        'FaceColor', 'none', 'EdgeColor', colors.validation, 'LineWidth', 1.45);
end
end
...
text(ax, box(1) + 0.020, tau_y + 0.030, 'decision vintage', ...
    'FontSize', 9.8, 'Color', colors.accent, 'VerticalAlignment', 'middle', ...
...
text(ax, u(1) + 0.047, u(2) + 0.020, 'cell to complete', ...
    'FontSize', 9.3, 'Color', colors.ink, 'BackgroundColor', colors.white, ...
...
text(ax, 0.555, 0.902, 'procedure choice', ...
    'FontSize', 9.8, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
text(ax, 0.842, 0.902, 'later release / validation', ...
    'FontSize', 9.4, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
end
...
text(ax, box(1) + box(3) / 2, box(2) + box(4) + 0.045, 'high-frequency operating grid', ...
    'FontSize', 10.0, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'Interpreter', 'none');
text(ax, box(1) + box(3) * 0.60, box(2) + box(4) - 0.040, 'lower-frequency release dates', ...
    'FontSize', 9.3, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
...
text(ax, x_br + 0.064, (y_low + y_high) / 2, 'aggregation restriction', ...
    'FontSize', 9.2, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
...
text(ax, box(1) + 0.25, box(2) + box(4) + 0.035, 'target population', ...
    'FontSize', 10.2, 'HorizontalAlignment', 'center', ...
...
text(ax, sep_x + 0.21, box(2) + 0.055, 'held-out validation cells', ...
    'FontSize', 9.2, 'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'middle', 'Color', colors.validation, ...
    'BackgroundColor', colors.white, 'Margin', 1.0, 'Interpreter', 'none');
end
...
text(ax, box2(1) + box2(3) / 2, box2(2) + 0.075, 'target-object loss', ...
    'FontSize', 10.7, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
