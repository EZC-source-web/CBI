...
draw_arrow(ax, [0.610 0.865], u + [-0.014 0.006], colors, '-', '', [], colors.accent, 1.5);
draw_arrow(ax, [0.845 0.865], u + [0.022 0.008], colors, '--', '', [], colors.feedback, 1.4);
text(ax, 0.570, 0.885, 'procedure choice', ...
    'FontSize', 9.0, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
text(ax, 0.850, 0.900, 'later release / validation', ...
...
for rr = p.release_rows
    ...
    plot(ax, [box(1) box(1) + box(3)], [y y], '-', ...
        'Color', colors.validation, 'LineWidth', 0.65);
end
text(ax, box(1) + box(3) / 2, box(2) + box(4) + 0.045, 'high-frequency operating grid', ...
    ...
    'Interpreter', 'none');
text(ax, box(1) + box(3) * 0.60, box(2) + box(4) - 0.045, 'lower-frequency release dates', ...
    'FontSize', 8.2, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
...
text(ax, x_br + 0.060, (y_low + y_high) / 2, 'aggregation restriction', ...
    'FontSize', 8.1, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
...
text(ax, sep_x + 0.20, box(2) + box(4) + 0.035, 'validation population', ...
    'FontSize', 9.0, 'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'middle', 'Interpreter', 'none');
text(ax, sep_x + 0.21, box(2) + 0.055, 'held-out validation cells', ...
    'FontSize', 8.2, 'HorizontalAlignment', 'center', ...
...
draw_arrow(ax, [0.435 arrow_y], [0.575 arrow_y], colors, '-', '', [], colors.accent, 1.6);
