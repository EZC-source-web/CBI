...
text(ax, 0.850, 0.900, 'later release validation', ...
    'FontSize', 8.8, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
    'BackgroundColor', colors.white, 'Margin', 1.2, 'Interpreter', 'none');
end
...
text(ax, box(1) + box(3) / 2, box(2) + box(4) + 0.045, 'high-frequency grid', ...
...
text(ax, x_br + 0.060, (y_low + y_high) / 2, 'aggregation restriction', ...
    'FontSize', 7.9, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', ...
...
text(ax, box2(1) + box2(3) / 2, box2(2) + 0.075, 'criterion loss', ...
